...
if (!empty($_POST['submit'])) {
	...
	if (!empty($_REQUEST["itemLocation"]))
        $data['itemLocation'] = $_REQUEST["itemLocation"];//itemlocation
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>เพิ่มสินค้าด้วยตนเอง</title>
    </head>
    <body>
        <div>
...
?>
                ...
                <div class="content">
                    ...
                    <input type="submit" name="submit" id="updateproduct" value="เพิ่ม">
